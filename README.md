...
|---|--------|-----------|----------------|-------|
| 1 | `1. ChromaDB` | [Embeddings and a real vector store](1.%20ChromaDB/1_Creating_Embeddings_using_Chroma.ipynb), [Semantic search and RAG](1.%20ChromaDB/2_Semantic_Search_and_RAG_with_ChromaDB.ipynb) | Embedding functions, collections, metadata, `where` filters, `query()`, distances, a RAG pipeline with citations, an optional fully local variant | OpenAI key (optional in nb 1) |
